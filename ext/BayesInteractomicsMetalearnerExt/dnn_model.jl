...
# This block runs only when this file is executed directly (standalone training).
# When included by the main module, the if-block is skipped and Flux is provided
# by the package environment. The standalone training scripts live in
# scripts/dnn_training/ and share its Project.toml.
if abspath(PROGRAM_FILE) == @__FILE__
    import Pkg; Pkg.activate("./scripts/dnn_training/");
    import Flux
    using CUDA
